...
class CustomDataStore:
    ...
    async def get(self, db: AsyncSession, entity_type: str, entity_key: str) -> Optional[dict]:
    ...
    async def get_batch(self, db: AsyncSession, entity_type: str, entity_keys: list[str]) -> dict[str, dict]:
    ...
    async def upsert(self, db: AsyncSession, entity_type: str, entity_key: str, data: dict) -> dict:
    ...
    async def replace(self, db: AsyncSession, entity_type: str, entity_key: str, data: dict) -> dict:
    ...
    async def delete(self, db: AsyncSession, entity_type: str, entity_key: str) -> bool:
    ...
    async def delete_all_for_entity(self, db: AsyncSession, entity_key: str) -> int:
